...
短链接 转换 ：百度短链接
查询银行代码
https://ccdcapi.alipay.com/validateAndCacheCardInfo.json?cardNo=6222620510027282419&cardBinCheck=true
...
class Spider:
    ...
    def run(self):
        ...
        # content = ['621792***9050', 'SPDB', '王俊连', '浦发银行', '1912041650091559704']
