...
class BigExcel:
    def __init__(self,path = "excel_res"):
        ...
        '10001': 'Thrasher',
        '10002': 'Y-3','10012': 'Balenciaga','10013': 'Neil Barrett','10014': 'KENZO','10016': 'Vetements',
        '10017': 'PLACES+FACES','10018': '大疆',
        '10019': 'Givenchy','10021': 'Cav Empt','10022': 'LONGINES','10024': 'BANDAI','10027': 'DICKIES',
        '10029': 'McQ','10030': 'CarharttWIP','10031': 'Alpha Industries',
        '10033': 'Hasbro','10035': 'dyson','10037': 'C2H4','10038': 'KITH',
        '10039': 'Randomevent','10082': 'FOG','10084': 'Bounce','1222': 'NOAH','1245': 'OFF-WHITE',
        '13': 'Jordan', '1310': 'Champion','144': 'Nike','176': 'CONVERSE','1860': 'THOM BROWNE','2': 'Puma',
        '2389': 'LEGO','3': 'adidas','3023': 'UNDERCOVER','33': '李宁','34': '安踏','4': 'New Balance','421': 'Kaws',
        '439': 'Supreme','45': 'THE NORTH FACE','494': 'adidas original','4981': '虎扑优选','4985': 'Revenge Storm',
        '4988': 'OMEGA','4991': 'Medicom Toy','4992': 'FR2','4993': 'Fucking Awesome','577': 'PALACE',
        '6': 'Reebok','634': 'A BATHING APE','65': 'Apple', '7': 'Under Armour','8': 'Asics','843': 'CASIO','9': 'Vans'
        }
        self.path = path
        try:
            os.mkdir(self.path)
